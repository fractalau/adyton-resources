...
const ARTICLE = {
  ...
  date: "August 14, 2024",
  slug: "adyton-commences-field-work-on-feni-island-led-by-former-friedland-senior-geologist",
};

const FeniFieldWorkFriedland = () => (
...
export default FeniFieldWorkFriedland;
