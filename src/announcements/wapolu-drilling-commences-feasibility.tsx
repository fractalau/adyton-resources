...
const ARTICLE = {
  ...
  slug: "drilling-commences-at-fergusson-island-wapolu-gold-project-for-feasibility-and-production-planning",
};

const WapoluDrillingCommencesFeasibility = () => (
...
export default WapoluDrillingCommencesFeasibility;
