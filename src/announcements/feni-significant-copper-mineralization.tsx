...
const ARTICLE = {
  ...
  slug: "significant-copper-mineralization-in-addition-to-gold-on-feni-island",
};

const FeniSignificantCopperMineralization = () => (
...
export default FeniSignificantCopperMineralization;
