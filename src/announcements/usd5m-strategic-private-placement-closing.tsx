...
const ARTICLE = {
  ...
  date: "October 7, 2024",
  slug: "adyton-resources-corporation-closes-premium-to-market-usd5-million-strategic-private-placement",
};

const USD5MStrategicPrivatePlacementClosing = () => (
...
export default USD5MStrategicPrivatePlacementClosing;
