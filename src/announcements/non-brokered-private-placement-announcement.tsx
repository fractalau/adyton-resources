...
const ARTICLE = {
  ...
  slug: "adyton-resources-corporation-announces-non-brokered-private-placement",
};

const NonBrokeredPrivatePlacementAnnouncement = () => (
...
export default NonBrokeredPrivatePlacementAnnouncement;
