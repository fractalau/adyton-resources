...
const ARTICLE = {
  title: "Adyton to Recommence Work Activities on Feni Island Gold/Copper Project",
  date: "April 25, 2024",
  slug: "adyton-to-recommence-work-activities-on-feni-island-gold-copper-project",
};

const FeniRecommenceWorkActivities = () => (
...
export default FeniRecommenceWorkActivities;
