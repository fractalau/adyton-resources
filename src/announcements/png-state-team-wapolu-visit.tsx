...
const ARTICLE = {
  ...
  date: "March 12, 2025",
  slug: "png-government-state-team-visits-fergusson-island-wapolu-project-to-commence-operations-restart-permitting",
};

const PngStateTeamWapoluVisit = () => (
...
export default PngStateTeamWapoluVisit;
