...
const ARTICLE = {
  ...
  date: "June 26, 2024",
  slug: "adyton-identifies-resource-growth-potential-with-new-untested-drill-targets-at-the-feni-island-project",
};

const FeniResourceGrowthUntestedTargets = () => (
...
export default FeniResourceGrowthUntestedTargets;
