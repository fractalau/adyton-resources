...
const ARTICLE = {
  ...
  date: "March 27, 2024",
  slug: "adyton-resources-corporation-announces-non-brokered-private-placement-1",
};

const NonBrokeredPrivatePlacementMarch2024 = () => (
...
export default NonBrokeredPrivatePlacementMarch2024;
