...
const ARTICLE = {
  ...
  date: "March 20, 2025",
  slug: "adyton-resources-announces-drilling-advances-at-100-owned-feni-island-gold-copper-project",
};

const FeniDrillingAdvances100Owned = () => (
...
export default FeniDrillingAdvances100Owned;
