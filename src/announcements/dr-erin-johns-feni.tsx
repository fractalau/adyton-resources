    ...
    <main>
      ...
      <section className="py-14 md:py-18" style={{ background: "hsl(var(--off-white))" }}>
        <div className="container max-w-3xl">
          ...
          >
            <p className="mb-6">
              <strong>Brisbane, Australia – December 02, 2025 – Adyton Resources Corporation</strong> (TSX Venture: <strong>ADY</strong>) ("<strong>Adyton</strong>" or the "<strong>Company</strong>") is very pleased to announce the appointment of <strong>Dr. Erin Johns</strong> to its technical team, focusing on the Company's flagship <strong>Feni Gold-Copper Project</strong> in Papua New Guinea.
            </p>
            ...
            <ul className="mb-6">
              <li><strong>World-Class Lihir Au Deposit Expertise:</strong> Dr. Johns completed her PhD research specifically on the Lihir Gold Deposit, a neighbouring, world class alkalic-type epithermal gold deposit owned and operated by Newmont, which is crucial for understanding the geological controls at the Feni gold-copper deposit.</li>
              <li><strong>Targeted De-Risking:</strong> Dr. Johns' specialized knowledge will provide critical insights for Adyton to accurately vector towards high-grade Au-Cu zones and expand the resource at Feni, effectively derisking the exploration model.</li>
              <li><strong>Strategic Academic Ties:</strong> Dr. Johns maintains close connections with the Centre for Ore Deposits and Earth Sciences (CODES) at the University of Tasmania, a globally recognized leader in economic geology and volcanology.</li>
              <li><strong>Enhanced Exploration Capability:</strong> Dr. Johns' Lihir expertise directly aligns with the discovery process underway at Adyton's 100%-owned Feni Project, an existing 1.46moz alkalic-type gold-copper resource, and significantly strengthens the technical team as the Company advances its exploration and resource growth strategy.</li>
            </ul>
            ...
            <ul className="mb-6">
              <li>The Feni and Lihir deposits are both classic examples of alkalic-type epithermal gold deposits, which represents a highly valuable, yet geologically complex, class of mineral systems globally.</li>
              <li>Dr. Johns' PhD thesis at the University of Tasmania's renowned CODES department focused on the geological controls that concentrated gold mineralization at Lihir. Understanding the relationship between these controls and the deep-seated intrusive complex is paramount.</li>
              <li>The full-time appointment ensures that Adyton is applying a "Lihir-style" geological lens and learnings to the Feni Project. This provides the technical team with the ability to swiftly interpret new data, recognize subtle alteration signatures, and refine targeting, dramatically increasing the probability of a major discovery.</li>
            </ul>
