...
const ARTICLE = {
  ...
  date: "July 17, 2024",
  slug: "review-of-existing-and-historical-data-on-feni-island-reinforces-significant-cu-au-discovery-potential",
};

const FeniHistoricalDataCuAu = () => (
...
export default FeniHistoricalDataCuAu;
