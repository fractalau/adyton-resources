  ...
  return (
    <section className="relative min-h-[520px] md:min-h-[620px] flex items-center overflow-hidden">
      {HERO_IMAGES.map((src, i) => (
        <div
          key={src}
          className={`absolute inset-0 bg-cover bg-center lg:bg-[length:110%_auto] xl:bg-[length:100%_auto] bg-[center_40%] transition-opacity duration-[3000ms] ease-in-out ${
      ...
      <div className="container relative z-10 py-20 md:py-28">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            ...
            <Button variant="gold" size="lg" asChild>
              <Link to="/projects/fergusson">Explore Fergusson Island Project</Link>
            </Button>
          </div>
        </div>
      </div>
