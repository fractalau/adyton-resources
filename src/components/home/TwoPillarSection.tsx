...
const TwoPillarSection = () => (
  <section className="py-16 md:py-20" style={{ background: "hsl(var(--off-white))" }}>
    <div className="container">
      ...
      <p
        className="text-center max-w-2xl mx-auto mb-12 font-body"
        style={{ color: "hsl(var(--light-muted-foreground))" }}
      >
        Adyton operates a dual-track strategy: near-term cash flow from Fergusson Island, funded through a joint venture
        at zero capital cost to Adyton — and district-scale exploration growth at Feni Island. This structure is
        designed to weather market cycles while pursuing discovery, providing resilience and structural durability that
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div
          className="rounded-lg p-6 md:p-8 border relative overflow-hidden"
