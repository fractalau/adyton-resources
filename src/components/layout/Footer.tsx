        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                to="/investors#capital-structure-section"
                className="text-sm text-foreground/60 hover:text-primary transition-colors font-body"
              >
                Capital Structure
              </Link>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/why-png" className="text-sm text-foreground/60 hover:text-primary transition-colors font-body">
                PNG & Community
              </Link>
            </div>
      ...
      >
        <div className="container">
          ...
          <p className="mt-3">
            ...
            Wapolu Gold Project (Jan 7, 2026 — filed SEDAR+ Feb 25, 2026). Qualified Person: Dr. Chris Bowden PhD,
            GCMEE, FAusIMM(CP), FSEG, COO & Chief Geologist, Adyton Resources Corp.
          </p>
        </div>
      </div>
    </footer>
