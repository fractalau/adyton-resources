...
const categorize = (title: string, slug: string): Category => {
  ...
  if (haystack.includes("fergusson") || haystack.includes("gameta") || haystack.includes("wapolu"))
    return "Fergusson Island";
  if (haystack.includes("feni") || haystack.includes("lihir")) return "Feni Island";
  return "News";
};
...
const ANNOUNCEMENTS: { title: string; date: string; sourceUrl: string }[] = [
  ...
  {
    title:
      "Adyton Confirms Significant Scale at Feni Gold-Copper Project: FDD005 Returns 158m @ 0.72g/t Au.Eq and Identifies New High-Priority Drill Targets",
    date: "October 15, 2025",
    sourceUrl:
      "/news/adyton-confirms-significant-scale-at-feni-gold-copper-project-fdd005-returns-158m-0-72g-t-au-eq-0-54g-t-au-0-14-cu-and-identifies-new-high-priority-drill-targets",
  },
  {
    title: "Adyton Reports Final Assays from FDD004 Confirming Strong Mineralized Intercepts at Feni Island",
    date: "September 9, 2025",
    sourceUrl:
      "/news/adyton-reports-final-assays-from-fdd004-confirming-strong-mineralized-intercepts-of-115m-at-1-00g-t-gold-equivalent-0-92g-t-au-0-07-cu-within-a-broader-mineralized-zone-of-229m-at-0-79g-t-gold-equ",
  },
  {
    title:
      "Adyton Reports Final Assays From Feni Drillholes 1-3 Confirming Multiple Copper Mineralised Zones; FDD003 Upgraded By 40% For Combined 125.9 Gxm (Au.eq)",
    date: "August 29, 2025",
    sourceUrl:
      "/news/adyton-reports-final-assays-from-feni-drillholes-1-3-confirming-multiple-copper-mineralised-zones-complementing-previously-reported-gold-fdd003-upgraded-by-40-for-combined-125-9-gxm-au-eq",
  },
  {
    title:
    ...
    date: "August 14, 2025",
    sourceUrl:
      "/news/adyton-resources-closes-oversubscribed-c20-million-financing-comprised-of-14-million-brokered-private-placement-of-units-and-concurrent-6-million-nonbrokered-private-placements",
  },
  {
  ...
  },
  {
    ...
    date: "July 24, 2025",
    sourceUrl:
      "/news/adyton-resources-announces-upsized-c20-million-financing-comprised-of-14-million-private-placement-of-units-and-concurrent-6-million-non-brokered-private-placement-of-units",
  },
  {
    title:
    ...
    date: "July 23, 2025",
    sourceUrl:
      "/news/adyton-reports-multiple-significant-gold-intersections-from-its-feni-island-gold-copper-project-drilling",
  },
  {
  ...
  },
  {
    ...
    date: "May 30, 2025",
    sourceUrl:
      "/news/adyton-resources-announces-filing-of-financial-statements-and-mda-for-the-three-months-ended-march-31-2025",
  },
  {
  ...
  },
  {
    ...
    date: "May 7, 2025",
    sourceUrl:
      "/news/adyton-reports-first-drill-intercepts-of-up-to-36-grams-per-tonne-gold-from-its-wapolu-drill-campaign",
  },
  {
    title:
      "Adyton Announces First Drill Samples From Latest Campaign At Its Feni Island Gold Project (With High Copper Prospectivity) Have Been Dispatched For Analysis",
    date: "April 30, 2025",
    sourceUrl:
      "/news/adyton-announces-first-drill-samples-from-latest-campaign-at-its-feni-island-gold-project-with-high-copper-prospectivity-have-been-dispatched-for-analysis",
  },
  {
    title:
      "Adyton Resources Announces Filing Of Financial Statements And MD&A For The Period Ending December 31, 2024 And Provides Corporate Update",
    date: "April 24, 2025",
    sourceUrl:
      "/news/adyton-resources-announces-filing-of-financial-statements-and-mda-for-the-period-ending-december-31-2024-and-provides-corporate-update",
  },
  {
  ...
  },
  {
    ...
    sourceUrl:
      "/news/adyton-expands-discovery-capability-at-feni-gold-copper-project-with-global-ore-discovery-consultants",
  },
  {
    title:
    ...
    sourceUrl:
      "/news/adyton-resources-receives-non-binding-letter-of-intent-loi-for-the-purchase-of-gold-concentrate-from-its-wapolu-project",
  },
  {
    title:
    ...
    sourceUrl:
      "/news/adyton-resources-welcomes-lihir-deposit-expert-dr-erin-johns-to-the-team-to-drive-feni-gold-copper-project-development",
  },
  {
  ...
  },
  {
    ...
    date: "March 26, 2025",
    sourceUrl:
      "/news/adyton-resources-completes-over-4000m-drilling-at-wapolu-and-prepares-for-gameta-drilling-with-unanimous-landowner-support",
  },
  {
  ...
  },
  {
    ...
    date: "March 12, 2025",
    sourceUrl:
      "/news/png-government-state-team-visits-fergusson-island-wapolu-project-to-commence-operations-restart-permitting",
  },
  {
  ...
  },
  {
    ...
    sourceUrl:
      "/news/drilling-commences-at-fergusson-island-wapolu-gold-project-for-feasibility-and-production-planning",
  },
  {
  ...
  },
  {
    ...
    date: "July 17, 2024",
    sourceUrl:
      "/news/review-of-existing-and-historical-data-on-feni-island-reinforces-significant-cu-au-discovery-potential",
  },
  {
    title: "Adyton identifies resource growth potential with new untested drill targets at the Feni Island Project",
    date: "June 26, 2024",
    sourceUrl:
      "/news/adyton-identifies-resource-growth-potential-with-new-untested-drill-targets-at-the-feni-island-project",
  },
  {
  ...
  {
    title:
      "EVIH Technical and Executive Team Visit Fergusson Island to Commence Feasibility Study and Bulk Sample Planning",
    date: "May 29, 2024",
    sourceUrl:
      "/news/evih-technical-and-executive-team-visit-fergusson-island-to-commence-feasibility-study-and-bulk-sample-planning",
  },
  {
    title:
    ...
    date: "May 13, 2024",
    sourceUrl:
      "/news/adyton-and-east-vision-international-holdings-execute-us9-5m-investment-and-development-agreement-for-the-fergusson-island-gold-project",
  },
  {
    title:
      "Adyton Resources Announces Filing of Financial Statements and MD&A for the three and twelve months ended December 31, 2023",
    date: "April 26, 2024",
    sourceUrl:
      "/news/adyton-resources-announces-filing-of-financial-statements-and-mda-for-the-three-and-twelve-months-ended-december-31-2023",
  },
];
      ...
      <main>
        ...
        <section className="relative bg-background py-16 md:py-20 border-b border-border overflow-hidden">
          ...
          <div className="container relative z-10">
            ...
            <p className="text-sm text-foreground/40 mt-2 font-mono">
              {newsItems.length} press releases · {ANNOUNCEMENTS.length} announcements
            </p>
          </div>
        </section>
        <Subscribe />
        ...
        <section id="news-section" aria-label="News" className="py-14 md:py-18 bg-background">
          <div className="container">
            ...
            {(() => {
              ...
              const visible =
                isAll && !showAllAnnouncements ? filteredAnnouncements.slice(0, 12) : filteredAnnouncements;
              const canShowMore = isAll && !showAllAnnouncements && filteredAnnouncements.length > 12;
              return (
                <>
                  <div
                    key={`${activeCategory}-${showAllAnnouncements}`}
                    className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 animate-fade-in"
                  >
                    {visible.map((a) => (
                      <NewsCard
                        key={a.sourceUrl}
