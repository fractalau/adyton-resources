...
const pngFaqs = [
  { question: "Why is Papua New Guinea attractive for gold exploration?", answer: "PNG sits on the Pacific Ring of Fire and has produced over 100 million ounces of gold historically. Major miners like Newmont, Barrick, and Harmony Gold operate successfully in the country, yet it remains significantly under-explored compared to peer jurisdictions like Australia and Canada." },
  { question: "What mining companies operate in PNG?", answer: "Major mining companies with active operations in PNG include Newmont (Lihir Gold Mine), Barrick Gold (Porgera), Harmony Gold (Hidden Valley), and K92 Mining. The country has a modernised Mining Act that provides a clear framework for exploration and development." },
  ...
  <div className="min-h-screen bg-background">
    ...
    <main>
      ...
      <section aria-label="Stakeholder principles" className="py-14 md:py-18" style={{ background: "hsl(var(--off-white))" }}>
        <div className="container max-w-3xl">
          <p className="uppercase tracking-[0.3em] text-primary font-semibold mb-3 font-body">COMMUNITY & STAKEHOLDERS</p>
          ...
          <div className="space-y-6">
            {pngFaqs.map((faq) => (
              <div key={faq.question}>
                ...
                <p className="text-sm text-foreground/60 font-body leading-relaxed">{faq.answer}</p>
              </div>
            ))}
          </div>
        </div>
