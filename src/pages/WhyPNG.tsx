...
const facts = [
  {
    ...
    points: [
      ...
      "The PNG mineral province has produced over 60-70 million ounces of gold historically.",
      "The Mineral Resources Authority estimates PNG still holds roughly 100 million ounces of unmined gold.",
...
const pngFaqs = [
  ...
  },
  {
    ...
    answer:
      "PNG has a long history of successful mining operations and a modernised Mining Act. The government actively supports responsible resource development. While infrastructure challenges exist, island-based projects like those held by Adyton benefit from easy ocean access and simplified logistics.",
  },
];
